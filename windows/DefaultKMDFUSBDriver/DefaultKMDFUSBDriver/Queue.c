...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, DefaultKMDFUSBDriverQueueInitialize)
#endif

NTSTATUS
DefaultKMDFUSBDriverQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = DefaultKMDFUSBDriverEvtIoDeviceControl;
    queueConfig.EvtIoStop = DefaultKMDFUSBDriverEvtIoStop;
...
VOID
DefaultKMDFUSBDriverEvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
