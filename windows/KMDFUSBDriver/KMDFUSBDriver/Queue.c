...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, KMDFUSBDriverQueueInitialize)
#endif

NTSTATUS
KMDFUSBDriverQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = KMDFUSBDriverEvtIoDeviceControl;
    queueConfig.EvtIoStop = KMDFUSBDriverEvtIoStop;
...
VOID
KMDFUSBDriverEvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
