...
a = Analysis(['src\\administrative_assistant.py'],
             pathex=['D:\\Github\\Storage\\qt\\python\\administrative_assistant'],
             binaries=[],
             datas=[],
             hiddenimports=[],
             hookspath=[],
...
exe = EXE(pyz,
          ...
          upx_exclude=[],
          runtime_tmpdir=None,
          console=False , version='doc\\file_version_info.txt', icon='img\\logo.ico')
