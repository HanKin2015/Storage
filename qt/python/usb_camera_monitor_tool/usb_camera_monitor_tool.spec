...
a = Analysis(['src\\usb_camera_monitor_tool.py'],
             pathex=['D:\\Github\\Storage\\qt\\python\\usb_camera_monitor_tool'],
             binaries=[],
             datas=[],
             hiddenimports=[],
             hookspath=[],
...
exe = EXE(pyz,
          ...
          upx_exclude=[],
          runtime_tmpdir=None,
          console=False , version='doc\\file_version_info.txt', icon='img\\usb_camera_monitor_tool.ico')
