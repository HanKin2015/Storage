...
[root@ubuntu0006:~/kernel/hj] #lsmod | grep hello
[root@ubuntu0006:~/kernel/hj] #dmesg -T | tail
[二 7月 15 16:21:35 2025] hello: loading out-of-tree module taints kernel.
[二 7月 15 16:21:35 2025] hello: module verification failed: signature and/or required key missing - tainting kernel
[二 7月 15 16:21:35 2025] hello, init
[二 7月 15 16:21:35 2025] audit: type=1400 audit(1752567697.233:164): apparmor="DENIED" operation="open" class="file" profile="rsyslogd" name="/run/systemd/sessions/" pid=1277 comm=72733A6D61696E20513A526567 requested_mask="r" denied_mask="r" fsuid=102 ouid=0
[二 7月 15 16:22:21 2025] hello, exit
[二 7月 15 16:22:21 2025] audit: type=1400 audit(1752567742.710:165): apparmor="DENIED" operation="open" class="file" profile="rsyslogd" name="/run/systemd/sessions/" pid=1277 comm=72733A6D61696E20513A526567 requested_mask="r" denied_mask="r" fsuid=102 ouid=0
```

## 3、理解
- 只需要包含#include <linux/module.h>头文件即可
- .ko就是驱动文件
- lsmod、rmmod、insmod、dmesg
