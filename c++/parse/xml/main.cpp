 ...
 * 学习tinyxml2.cpp文件的使用
 * 
 * 摘自: https://blog.csdn.net/fengbingchun/article/details/99689509
 * 
 * date: 2021.05.26
 * author: hankin
 * 
...
int test_tinyxml2_create()
{
	...
	tinyxml2::XMLText* text3 = doc.NewText("https://hankin2015.github.io");
	addr->InsertEndChild(text3);
	blog2->InsertEndChild(addr);
	
	tinyxml2::XMLElement* id = doc.NewElement("ID");
	tinyxml2::XMLText* text4 = doc.NewText("hankin");
	...
	tinyxml2::XMLText* text5 = doc.NewText("https://github.com//hankin2015");
...
#ifdef _MSC_VER
	const char* file_name = "./test1.xml"; 
#else
	const char* file_name = "./test2.xml";
#endif
