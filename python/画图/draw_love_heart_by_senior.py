# -*- coding: utf-8 -*-
"""
文 件 名: draw_love_heart_by_senior.py
文件描述: 李峋同款：跳动爱心
备    注: https://mp.weixin.qq.com/s/4_Sm7PaoNJ6e6x2yhXZL8Q
作    者: HanKin
创建日期: 2023.07.17
修改日期：2023.07.17
...
class Heart:
    ...
    def __init__(self, generate_frame=20):
        ...
        self.edge_diffusion_points = set()# 边缘扩散效果点坐标集合
        self.center_diffusion_points = set()#中心扩散效果点坐标集合
...
def draw(main: Tk, render_canvas: Canvas, render_heart: Heart,
    ...
    main.after(1,draw, main, render_canvas, render_heart, render_frame +
    1)
